...
<template>
  <nav class="w-full bg-[#0F131D50] text-white xl:px-[80px]">
    <div class="relative flex flex-wrap items-center justify-between mx-auto px-4 py-3">
      ...
      >
        <ul
          class="lg:flex flex-col hidden md:flex-row items-center space-y-3 md:space-y-0 md:space-x-8 text-[16px]"
        >
      ...
      <div class="flex items-center z-30 space-x-4">
        <button class="lg:hidden text-white" @click="toggleMenu">
          <svg
    ...
    <transition name="slide">
      <div
        v-if="isMobileMenuOpen"
        class="fixed top-0 pt-14 left-0 h-screen w-[80%] bg-[#0F131D] z-20 p-6 lg:hidden"
      >
